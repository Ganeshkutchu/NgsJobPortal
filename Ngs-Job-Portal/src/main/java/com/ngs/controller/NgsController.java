...
public class NgsController {
	...
	public String showForm(Model model) {
		// model.addAttribute("loginForm", new LoginForm(null, null, null)); // Add
		// loginForm object to the model
		return "home";
	}

	@GetMapping("/login")
	public String getLogin(Model model) {
		model.addAttribute("login", new LoginDto()); // Add loginForm object to the model
		return "login";
	}
...
//    @PostMapping()
//	public String loginTATeam(Model model, @ModelAttribute TALogin taLogin) {
//		boolean loginTATeam = ngsService.loginTATeam(taLogin.getLoginid());
//		if (loginTATeam) {
//			return "TATeam";
//		} else {
